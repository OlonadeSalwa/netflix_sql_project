...
![](https://github.com/OlonadeSalwa/netflix_sql_project/blob/main/netflix_logo.png)
...
**Objective:** Identify the top 10 countries with the highest number of content items.
